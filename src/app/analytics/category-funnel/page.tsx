...
import { CategoryConversionFunnel } from '@/components/first8marketing/woocommerce/CategoryConversionFunnel';
import { useNavigation } from '@/components/hooks/useNavigation';
import { DateFilter } from '@/components/input/DateFilter';
import { WebsiteSelect } from '@/components/input/WebsiteSelect';

export default function CategoryFunnelPage() {
  ...
  return (
    <main>
      <h1>Category Conversion Funnel</h1>
      {!selectedWebsite && (
        <div style={{ maxWidth: 400, margin: '2rem auto', textAlign: 'center' }}>
          ...
          <WebsiteSelect
            onChange={id => {
              ...
              router.push(`/analytics/category-funnel?websiteId=${id}`);
            }}
            style={{ width: '100%' }}
          />
        </div>
