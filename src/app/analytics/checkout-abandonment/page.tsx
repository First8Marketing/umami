...
import { CheckoutAbandonmentTracker } from '@/components/first8marketing/woocommerce/CheckoutAbandonmentTracker';
        ...
        <div style={{ maxWidth: 400, margin: '2rem auto', textAlign: 'center' }}>
          ...
          <WebsiteSelect
            onChange={id => {
              ...
              router.push(`/analytics/checkout-abandonment?websiteId=${id}`);
            }}
            style={{ width: '100%' }}
          />
        </div>
